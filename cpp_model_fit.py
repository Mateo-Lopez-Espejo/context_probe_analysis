...
# performs the cellwise population fit
...
# performs the single cell, population independent fit
...
# todo compare the goodness of fit, and fitted values for the stims (compare STRFs)
