...
script_path = '/auto/users/mateo/code/context_probe_analysis/scripts/0_cluster/mean_diff_cluster_mass/script.py'
...
for site, clust_thresh in itt.product(sites, cluster_thresholds):
    note = f'{site}_mean-diff_thresh-{clust_thresh}_cluster_mass'
