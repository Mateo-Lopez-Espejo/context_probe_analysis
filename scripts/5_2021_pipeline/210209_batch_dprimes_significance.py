...
summary_DF_file = pl.Path(config['paths']['analysis_cache']) / 'consolidated_summary_DF' / set_name(meta)
...
for site in sites:
    ...
    dprime, shuffled_dprime, goodcells, var_capt = full_dPCA_dprimes(site, **expt, meta=meta)
