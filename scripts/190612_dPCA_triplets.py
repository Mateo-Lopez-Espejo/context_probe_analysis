...
for probe in [2,3,5,6]:
    transitions = ['silence', 'sharp']
    trialR = tp.extract_sub_arr(probe=probe, context_types=transitions, full_array=full_array,
    ...
    # initializes model
    dpca = dPCA.dPCA(labels='ct',regularizer='auto')
    dpca.protect = ['t']
