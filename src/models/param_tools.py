...
def load_cell_formated_resp_pred(cellid, contexts='all', probes='all', part='probe', modelname=None, batch=None,
                                 **kwargs):
    ...
    raster_resp = raster_from_sig(resp, probes=probes, channels=resp.chans[0], contexts=contexts,
                                  smooth_window=meta['smoothing_window'], raster_fs=resp.fs,
...
if __name__ == '__main__':
    ...
    out = load_cell_formated_resp_pred(cellid, contexts='all', probes='all', part='probe', modelname=modelname,
                                       batch=batch)
